		...
		<nav className="bg-white shadow-lg fixed w-full z-10">
			<div className="container mx-auto px-6 py-3 md:flex md:items-center md:justify-between">
				<div className="flex justify-between items-center">
					<img
						className="h-12 md:h-14 text-2xl md:text-3xl inline pl-20"
						src="/images/logo.svg"
						alt="logo"
					/>
				...
				<div className={`md:flex ${open ? 'block' : 'hidden'} mt-4 md:mt-0`}>
					<ul className="md:flex md:items-center space-x-4 md:space-x-8 pr-40 text-center">
						...
						<Link
							to="Home"
							class="py-2 px-6 rounded-full self-center md:self-start text-white bg-orange-500 hover:bg-green-800">
							GET STARTED
						</Link>
					</ul>
				</div>
